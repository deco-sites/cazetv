...
export default function Header({
  ...
  return (
    <header
      class="text-white"
      style="background-color: #1f1f1f; height: 80px;"
    >
      <div class="container mx-auto px-4 lg:px-10 max-w-[1600px] h-full">
              ...
              <nav class="hidden md:flex space-x-8">
                {navigation.map((item, index) => (
                  <a
                    ...
                    class="text-white hover:text-gray-300 transition-colors duration-200 font-medium tracking-wide cursor-pointer"
                  >
                    {item.label}
                  </a>
                ))}
