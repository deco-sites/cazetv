...
export default function Header({
  logo = "https://assets.decocache.com/cazetv/48c13a7a-52ad-435b-bb41-03b02e62f4e7/logo-caze-tv.png",
  logoWidth = 132,
  logoHeight = 74,
  navigation = [
  ...
  return (
    <header class="text-white" style="background-color: #1f1f1f; height: 152px;">
      <div class="container mx-auto px-4 h-full">
        <div class="flex items-center justify-between h-full">
          ...
          {/* Navigation Menu */}
          {navigation && navigation.length > 0 && <nav class="hidden md:flex space-x-8">
